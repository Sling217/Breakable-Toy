...
const NewGameReviewForm = (props) => {
    ...
    const postNewParkReview = async () => {
        ...
        try {
            const response = await fetch(`/api/v1/games/${gameId}/reviews`, {
                method: "POST",
                headers: new Headers({
                    "Accept": "image/jpeg"
                }),
            ...
            props.setGame({
                ...props.game,
                reviews: [...props.game.reviews, responseBody.review]
            })
...
export default NewGameReviewForm